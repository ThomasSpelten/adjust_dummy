...
def singlescore(array1, array2, array3):
    tmp1=rescale(array1)
    tmp2=rescale(array2)
    tmp3=rescale(array3)
    sinsc=[]
...
sinsc_en=singlescore(co2em_en, eurem_en, matem_en)
...
sinsc_he=singlescore(co2em_he, eurem_he, matem_he)
...
chart_data=pd.DataFrame([[1, 2, 3], [2, 2, 2], [0, 0, 1]], columns=["Hallo", "Hubba", "Bubba"], )
